...
## 印尼
col = client['traveloka']['id_id_final']
cursor = col.find({}, no_cursor_timeout=True, batch_size=5)
filename = "./Traveloka/Traveloka_Indonesia_count_20260225.json"
...
## 日本
col = client['traveloka']['ja_jp_final']
cursor = col.find({}, no_cursor_timeout=True, batch_size=5)
filename = "./Traveloka/Traveloka_Japan_count_20260225.json"
f = open(filename, "w", encoding="utf-8")
count = 0
for i in cursor:
    del i['_id']
