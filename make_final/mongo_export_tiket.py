...
## 印尼
col = client['tiket']['id_id_final']
cursor = col.find({}, no_cursor_timeout=True, batch_size=5)
filename = "./Tiket/Tiket_Indonesia_count_20260225.json"
...
## 马来西亚
col = client['tiket']['en_my_final']
cursor = col.find({}, no_cursor_timeout=True, batch_size=5)
filename = "./Tiket/Tiket_Malaysia_count_20260225.json"
f = open(filename, "w", encoding="utf-8")
count = 0
for i in cursor:
    del i['_id']
