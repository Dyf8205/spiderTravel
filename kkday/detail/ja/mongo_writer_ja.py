...
# 配置
REDIS_RESULT_KEY = 'ja_kkday_result'
...
def writer(writer_id):
    ...
    if "details" not in collist:
        col = mongo_client["kkday"]["ja_details"]
        col.create_index("id", unique=True)
    if "error_urls" not in collist:
        col = mongo_client["kkday"]["ja_base_error_urls"]
        col.create_index("id", unique=True)

    success_col = mongo_client["kkday"]["ja_details"]
    error_col = mongo_client["kkday"]["ja_base_error_urls"]
